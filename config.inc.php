...
*/
	...
	$_SESSION['cfg_rootdir']		= '/home/xxx/public_html/filestore'; // Verzeichnis der index.php (Startdatei)

	$_SESSION['cfg_db_host'] = "localhost";
	$_SESSION['cfg_db_name'] = "db_name";
	$_SESSION['cfg_db_user'] = "username";
	$_SESSION['cfg_db_pass'] = "xxxxxxxxxxxxxx";
